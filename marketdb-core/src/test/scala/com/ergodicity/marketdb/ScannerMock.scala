...
class ScannerMockTest {
  ...
  @Test
  def testGroupByKey() {
    val payload1 = TradePayload(market, security, 11l, BigDecimal("111"), 1, new DateTime(2012, 01, 01, 01, 01, 0, 0), true)
    val payload2 = TradePayload(market, security, 11l, BigDecimal("111"), 1, new DateTime(2012, 01, 01, 01, 01, 1, 0), true)
    val payload3 = TradePayload(market, security, 11l, BigDecimal("111"), 1, new DateTime(2012, 01, 01, 01, 02, 1, 0), true)
  ...
  def testSplitToBatches() {
    ...
    for (i <- 1 to 95) {
      val payload = TradePayload(market, security, i, BigDecimal("111"), 1, new DateTime(2012, 01, 01, 01, 01, 0, i), true)
      list = payload :: list
    }
